      ...
      >
        ...
        <div className="absolute inset-0 flex lg:items-end justify-center p-4 sm:p-6 lg:p-8">
          <blockquote className="text-white max-w-lg">
            <p className="text-xl sm:text-2xl font-light italic mb-3 sm:mb-4 drop-shadow-md">"{quote.text}"</p>
            <footer className="text-base sm:text-lg drop-shadow-sm">— {quote.author}</footer>
          </blockquote>
        </div>
      </div>
    </div>
